...
Please review our [contributing guidelines](https://github.com/brillout/awesome-react-components/blob/master/CONTRIBUTING.md) ⭐ 48,309 | 🐛 87 | 📅 2026-01-26. We keep this list fresh by **requiring all PRs to remove one or more non-awesome entries from this list**. Please ONLY PR a new resource if you are ALSO removing one.
...
* [Handsontable](https://github.com/handsontable/handsontable) ⭐ 22,030 | 🐛 47 | 🌐 JavaScript | 📅 2026-09-01 - [demo](https://handsontable.com/demo) - [docs](https://handsontable.com/docs/react-data-grid/) - Data Grid with spreadsheet-like UI supporting React, Angular, TypeScript and JavaScript.
* [AG Grid](https://github.com/ag-grid/ag-grid) ⭐ 15,574 | 🐛 129 | 🌐 TypeScript | 📅 2026-09-01 - Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components.
* [react-data-grid](https://github.com/adazzle/react-data-grid) ⭐ 7,673 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-01 - Excel-like grid.
* [MUI X Data grid](https://github.com/mui/mui-x) ⭐ 5,843 | 🐛 1,530 | 🌐 TypeScript | 📅 2026-09-01 - [demo/docs](https://mui.com/x/react-data-grid/) - Fast and customizable data grid with advanced features for power users and complex use cases.
* [fortune-sheet](https://github.com/ruilisi/fortune-sheet) ⭐ 3,712 | 🐛 94 | 🌐 TypeScript | 📅 2025-12-15 - An online spreedsheet component that provides out-of-the-box features just like Excel.
* [revo-grid](https://github.com/revolist/revogrid) ⭐ 3,439 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-01 - [demo/docs](https://revolist.github.io/revogrid/) - Powerfull Data Grid for React / AngularJS / Vue / Web Components with advanced customization.
...
* [TanStack Table](https://github.com/tannerlinsley/react-table) ⭐ 28,395 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-31 - [demo](https://tanstack.com/table/v8/docs/examples/react/basic) - Headless UI for building powerful tables & datagrids
...
* [mantine-datatable](https://github.com/icflorescu/mantine-datatable) ⭐ 1,254 | 🐛 46 | 🌐 TypeScript | 📅 2026-08-07 - [demo/docs](https://icflorescu.github.io/mantine-datatable/) - Lightweight table component for Mantine UI applications, with lots of features
...
* [virtua](https://github.com/inokawa/virtua) ⭐ 3,731 | 🐛 63 | 🌐 TypeScript | 📅 2026-09-01 - [demo](https://inokawa.github.io/virtua/) - A zero-config, fast and small (\~3kB) virtual list component for React, Vue and Solid.
...
* [procaptcha](https://github.com/prosopo/captcha) ⭐ 298 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-01 - [demo](https://prosopo.io/) - [docs](https://docs.prosopo.io/) - Privacy focused free CAPTCHA
...
* [swiper](https://github.com/nolimits4web/Swiper) ⭐ 41,899 | 🐛 238 | 🌐 TypeScript | 📅 2026-08-28 - [demo](https://swiperjs.com/demos) - [docs](https://swiperjs.com/react) - The most modern free mobile touch slider with hardware accelerated transitions and amazing native behavior.
...
* [recharts](https://github.com/recharts/recharts) ⭐ 27,531 | 🐛 441 | 🌐 TypeScript | 📅 2026-09-01 - Redefined chart library built with React and D3.
...
* [kbar](https://github.com/timc1/kbar) ⭐ 5,248 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-10 - [demo](https://kbar.vercel.app) - Fast, portable, and extensible cmd+k interface.
...
* [Lucide](https://github.com/lucide-icons/lucide) ⭐ 24,275 | 🐛 516 | 🌐 TypeScript | 📅 2026-09-01 - Beautiful & consistent icon toolkit made by the community. Open-source project and a fork of Feather Icons.
...
* [react-paginate](https://github.com/AdeleD/react-paginate) ⭐ 2,766 | 🐛 70 | 🌐 JavaScript | 📅 2025-01-28 - A ReactJS component that creates a pagination.
...
* [react-markdown](https://github.com/rexxars/react-markdown) ⭐ 15,872 | 🐛 5 | 🌐 JavaScript | 📅 2025-04-21 - Render Markdown as React components.
...
* [puck](https://github.com/measuredco/puck) ⭐ 13,238 | 🐛 194 | 🌐 TypeScript | 📅 2026-09-01 - [demo](https://puck-editor-demo.vercel.app/edit) - The self-hosted visual editor for React
...
* [react-joyride](https://github.com/gilbarbara/react-joyride) ⭐ 7,849 | 🐛 4 | 🌐 TypeScript | 📅 2026-07-09 - Create walkthroughs and guided tours for your ReactJS apps. Now with standalone tooltips!.
...
* [react-advanced-news-ticker](https://github.com/ahmetcanaydemir/react-advanced-news-ticker) ⭐ 55 | 🐛 3 | 🌐 JavaScript | 📅 2021-08-23 - [demo](https://www.ahmetcanaydemir.com/react-advanced-news-ticker/) - A flexible and animated vertical news ticker component
...
* [react-day-picker](https://github.com/gpbl/react-day-picker) ⭐ 6,848 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-26 - Flexible date picker for React.
...
* [react-select](https://github.com/JedWatson/react-select) ⭐ 28,031 | 🐛 489 | 🌐 TypeScript | 📅 2026-07-16 - A Select control built with and for React JS.
...
* [react-colorful](https://github.com/omgovich/react-colorful) ⭐ 3,550 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-01 - A tiny (2,5 KB), dependency-free, fast and accessible color picker component.
...
* [sortablejs](https://github.com/SortableJS/Sortable) ⭐ 31,174 | 🐛 525 | 🌐 JavaScript | 📅 2026-03-24 - Lists reorderable by drag-and-drop, within and among lists.
...
* [tiptap](https://github.com/ueberdosis/tiptap) ⭐ 38,214 | 🐛 833 | 🌐 TypeScript | 📅 2026-09-01 - [demo](https://tiptap.dev/) - [docs](https://tiptap.dev/introduction) - The headless editor framework for web artisans.
...
* [ckeditor5-react](https://github.com/ckeditor/ckeditor5-react) ⭐ 467 | 🐛 78 | 🌐 TypeScript | 📅 2026-09-01 - An official CKEditor 5 rich text editor wrapper.
...
* [framer-motion](https://github.com/framer/motion) ⭐ 33,445 | 🐛 107 | 🌐 TypeScript | 📅 2026-09-01 - An animation and gesture library.
...
* [react-tsparticles](https://github.com/matteobruni/tsparticles/blob/master/components/react/README.md) ⭐ 8,974 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-31 - A lightweight component to easily create interactive particles animations
...
* [react-parallax-tilt](https://github.com/mkosir/react-parallax-tilt) ⭐ 1,079 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-31 - [demo](https://mkosir.github.io/react-parallax-tilt) - Easily apply parallax tilt hover effect on components.
...
* [shadcn/ui](https://github.com/shadcn-ui/ui) ⭐ 122,725 | 🐛 2,071 | 🌐 TypeScript | 📅 2026-09-01 - [demo](https://ui.shadcn.com/examples/mail) - [docs](https://ui.shadcn.com/docs) - Beautifully designed components that you can copy and paste into your apps.
* [ant-design](https://github.com/ant-design/ant-design) ⭐ 99,343 | 🐛 1,103 | 🌐 TypeScript | 📅 2026-09-01 - [demo/docs](https://ant.design/docs/react/introduce) - A UI Design Language from China. Individual [components](http://react-component.github.io/) available.
* [chakra-ui](https://github.com/chakra-ui/chakra-ui) ⭐ 40,613 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-30 - [demo/docs](https://chakra-ui.com) - Simple, Modular & Accessible UI Components for your React Applications.
* [Mantine](https://github.com/mantinedev/mantine) ⭐ 31,650 | 🐛 50 | 🌐 TypeScript | 📅 2026-09-01 - [demo/docs](https://mantine.dev/) - A fully featured library with 100+ hooks and components with native dark theme support
* [react-bootstrap](https://github.com/react-bootstrap/react-bootstrap) ⭐ 22,604 | 🐛 235 | 🌐 TypeScript | 📅 2026-09-01 - Bootstrap components built with React.
* [fluentui](https://github.com/microsoft/fluentui) ⭐ 20,242 | 🐛 793 | 🌐 TypeScript | 📅 2026-09-01 - UX frameworks for creating beautiful, cross-platform apps that share code, design, and interaction behavior.
...
* [evergreen](https://github.com/segmentio/evergreen) ⭐ 12,421 | 🐛 81 | 🌐 JavaScript | 📅 2026-06-25 - [demo/docs](https://evergreen.segment.com) - Evergreen React UI Framework by Segment.
* [semi-design](https://github.com/DouyinFE/semi-design) ⭐ 10,339 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-01 - [demo/docs](https://semi.design/) - A modern, comprehensive, flexible design system.
* [carbon](https://github.com/carbon-design-system/carbon) ⭐ 9,398 | 🐛 1,012 | 🌐 JavaScript | 📅 2026-09-01 - [demo/docs](https://www.carbondesignsystem.com/) - A design system built by IBM.
* [reakit](https://github.com/ariakit/ariakit) ⭐ 8,608 | 🐛 43 | 🌐 TypeScript | 📅 2026-09-01 - [demo/docs](https://reakit.io/docs/button/) Toolkit for building accessible rich web apps
* [grommet](https://github.com/grommet/grommet) ⭐ 8,353 | 🐛 472 | 🌐 JavaScript | 📅 2026-08-31 - The most advanced UX framework for enterprise applications.
...
* [kokonut-ui](https://github.com/kokonut-labs/kokonutui) ⭐ 2,069 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-20 - Free Modern and Customizable UI components.
* [untitled-ui-react](https://github.com/untitleduico/react) ⭐ 1,893 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-31 - [demo](https://www.untitledui.com/react/) - Beautifully crafted collection of components built with React Aria and Tailwind CSS.
...
* 🚀 [Material UI](https://github.com/mui/material-ui) ⭐ 98,983 | 🐛 1,483 | 🌐 JavaScript | 📅 2026-09-01 - Full suite of components. Build your own design system, or start with Material Design.
...
* [refine](https://github.com/pankod/refine) ⭐ 35,607 | 🐛 45 | 🌐 TypeScript | 📅 2026-06-05 - [demo](https://example.refine.dev) - [docs](https://refine.dev/docs) - Build data-intensive applications in no time. It ships with Ant Design System, an enterprise-level UI toolkit.
* [react-admin](https://github.com/marmelab/react-admin) ⭐ 26,916 | 🐛 65 | 🌐 TypeScript | 📅 2026-09-01 - Build admin user experiences on top of REST and GraphQL services.
* [blueprint](https://github.com/palantir/blueprint) ⭐ 22,021 | 🐛 941 | 🌐 TypeScript | 📅 2026-09-01 - [demo](https://blueprintjs.com/) - [docs](https://blueprintjs.com/docs/) - UI toolkit for building complex, data-dense web interfaces for desktop (not mobile) applications.
...
* [redux](https://github.com/reactjs/redux) ⭐ 61,511 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-20 - Predictable state container for JavaScript apps.
* [zustand](https://zustand.surge.sh/) - [docs](https://github.com/pmndrs/zustand) ⭐ 58,633 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-31 - A fast bearbones state-management solution using simplified flux principles and boilerplate-free hook api.
* [react-redux](https://github.com/reactjs/react-redux) ⭐ 23,443 | 🐛 58 | 🌐 TypeScript | 📅 2026-09-01 - Official React bindings for Redux.
* [RxDB](https://rxdb.info/) - [demo](https://github.com/pubkey/rxdb/tree/master/examples/react) ⭐ 23,373 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-01 - [docs](https://rxdb.info/quickstart.html) A fast, local first, reactive Database for JavaScript Applications
* [reselect](https://github.com/reactjs/reselect) ⭐ 19,017 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-22 - Selector library for Redux.
...
* [react-hook-form](https://github.com/react-hook-form/react-hook-form) ⭐ 44,841 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-31 - React hooks for form validation without the hassle.
...
* [react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) ⭐ 15,882 | 🐛 144 | 🌐 TypeScript | 📅 2026-08-30 - A React component for building Web forms from JSONSchema.
...
* [surveyjs](https://github.com/surveyjs/survey-library) ⭐ 4,863 | 🐛 484 | 🌐 TypeScript | 📅 2026-09-01 - The advanced Survey and Form library
* [formsy-react](https://github.com/formsy/formsy-react/) ⭐ 762 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-01 - A form input builder and validator for React JS.
...
* [tanstack-router](https://github.com/TanStack/router) ⭐ 15,022 | 🐛 595 | 🌐 TypeScript | 📅 2026-09-01 - Type-safe router with built-in caching & URL state management
* [wouter](https://github.com/molefrog/wouter) ⭐ 7,870 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-21 - A minimalist-friendly \~1.3KB routing library. Nothing else but hooks.
...
* [query](https://github.com/TanStack/query) ⭐ 50,242 | 🐛 145 | 🌐 TypeScript | 📅 2026-09-01 - [docs](https://tanstack.com/query/v4) Powerful asynchronous state management, server-state utilities and data fetching for TS/JS, React, Solid, Svelte and Vue.
* [apollo-client](https://github.com/apollostack/apollo-client) ⭐ 19,813 | 🐛 405 | 🌐 TypeScript | 📅 2026-08-31 - A simple caching client for any GraphQL server and UI framework.
* [react-relay](https://github.com/facebook/relay) ⭐ 18,959 | 🐛 859 | 🌐 Rust | 📅 2026-08-31 - Relay is a JavaScript framework for building data-driven React applications.

### CSS / Style

* [styled-components](https://github.com/styled-components/styled-components) ⭐ 41,121 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-28 - Visual primitives for the component age.
...
* [create-react-app](https://github.com/facebookincubator/create-react-app) ⭐ 103,276 | 🐛 2,411 | 🌐 JavaScript | 📅 2025-02-15 - Create React apps with no build configuration.
* [electron-react-boilerplate](https://github.com/chentsulin/electron-react-boilerplate) ⭐ 24,254 | 🐛 191 | 🌐 TypeScript | 📅 2026-09-01 - Live editing development on desktop app.
...
* [react-call](https://github.com/desko27/react-call) ⭐ 1,368 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-01 - Call your React components.
...
* [react-intl](https://github.com/yahoo/react-intl) ⭐ 14,746 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-01 - Internationalize React apps.
* [react-i18next](https://github.com/i18next/react-i18next) ⭐ 10,041 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-01 - Internationalization for react done right. Using the i18next i18n ecosystem.
* [js-lingui](https://github.com/lingui/js-lingui) ⭐ 5,866 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-01 - [docs](https://lingui.js.org) – A readable, automated, and optimized (5 kb) internationalization for JavaScript.
...
* [react-on-rails](https://github.com/shakacode/react_on_rails) ⭐ 5,190 | 🐛 116 | 🌐 Ruby | 📅 2026-09-01 - Integration of React + Webpack + Rails to build Universal (Isomorphic) Apps.
...
* [react-lottie-player](https://github.com/mifi/react-lottie-player) ⭐ 533 | 🐛 24 | 🌐 JavaScript | 📅 2026-09-01 - [demo](https://mifi.github.io/react-lottie-player/) - Declarative lottie animation player.
...
* [playwright](https://github.com/microsoft/playwright) ⭐ 95,481 | 🐛 179 | 🌐 TypeScript | 📅 2026-09-01 enables reliable end-to-end testing for modern web apps.
* [jest-cli](https://github.com/facebook/jest) ⭐ 45,472 | 🐛 189 | 🌐 TypeScript | 📅 2026-09-01 - Painless JavaScript Testing.
* [enzyme](https://github.com/airbnb/enzyme) ⭐ 19,818 | 🐛 282 | 🌐 JavaScript | 📅 2025-10-22 - JavaScript Testing utilities for React.
...
* [redux-devtools](https://github.com/gaearon/redux-devtools) ⭐ 14,367 | 🐛 230 | 🌐 TypeScript | 📅 2026-09-01 - DevTools for Redux with hot reloading, action replay, and customizable UI.
...
* [standard-react](https://github.com/feross/standard) ⭐ 29,435 | 🐛 128 | 🌐 JavaScript | 📅 2025-07-11 - JavaScript Standard Style Guide.
...
* [jsonx](https://github.com/repetere/jsonx) ⭐ 184 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-01 - React JSON Syntax.
* [jsondiffpatch-react](https://github.com/bluepeter/jsondiffpatch-react) ⭐ 12 | 🐛 0 | 🌐 JavaScript | 📅 2023-07-11 - JSON diffing.

### Static Website Generator

* [gatsby](https://github.com/gatsbyjs/gatsby) ⭐ 55,943 | 🐛 438 | 🌐 JavaScript | 📅 2026-08-29 - Transform plain text into dynamic blogs and websites using React.js.
