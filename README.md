...
Please review our [contributing guidelines](https://github.com/brillout/awesome-react-components/blob/master/CONTRIBUTING.md) ⭐ 48,484 | 🐛 93 | 📅 2026-01-26. We keep this list fresh by **requiring all PRs to remove one or more non-awesome entries from this list**. Please ONLY PR a new resource if you are ALSO removing one.
...
* [Handsontable](https://github.com/handsontable/handsontable) ⭐ 22,050 | 🐛 21 | 🌐 JavaScript | 📅 2026-09-25 - [demo](https://handsontable.com/demo) - [docs](https://handsontable.com/docs/react-data-grid/) - Data Grid with spreadsheet-like UI supporting React, Angular, TypeScript and JavaScript.
* [AG Grid](https://github.com/ag-grid/ag-grid) ⭐ 15,616 | 🐛 122 | 🌐 TypeScript | 📅 2026-09-25 - Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components.
* [react-data-grid](https://github.com/adazzle/react-data-grid) ⭐ 7,689 | 🐛 78 | 🌐 TypeScript | 📅 2026-09-24 - Excel-like grid.
* [MUI X Data grid](https://github.com/mui/mui-x) ⭐ 5,853 | 🐛 1,201 | 🌐 TypeScript | 📅 2026-09-25 - [demo/docs](https://mui.com/x/react-data-grid/) - Fast and customizable data grid with advanced features for power users and complex use cases.
...
* [TanStack Table](https://github.com/tannerlinsley/react-table) ⭐ 28,453 | 🐛 70 | 🌐 TypeScript | 📅 2026-09-16 - [demo](https://tanstack.com/table/v8/docs/examples/react/basic) - Headless UI for building powerful tables & datagrids
...
* [virtua](https://github.com/inokawa/virtua) ⭐ 3,747 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-24 - [demo](https://inokawa.github.io/virtua/) - A zero-config, fast and small (\~3kB) virtual list component for React, Vue and Solid.
...
* [react-hot-toast](https://github.com/timolins/react-hot-toast) ⭐ 10,975 | 🐛 138 | 🌐 TypeScript | 📅 2026-09-16 - [demo](https://react-hot-toast.com/) - Smoking hot Notifications for React. Lightweight, customizable and beautiful by default.
...
* [react-tabs](https://github.com/reactjs/react-tabs) ⭐ 3,148 | 🐛 58 | 🌐 JavaScript | 📅 2026-09-25 - React tabs component.
...
* [recharts](https://github.com/recharts/recharts) ⭐ 27,590 | 🐛 445 | 🌐 TypeScript | 📅 2026-09-25 - Redefined chart library built with React and D3.
...
* [react-player](https://github.com/CookPete/react-player) ⭐ 10,282 | 🐛 62 | 🌐 TypeScript | 📅 2025-11-13 - A react component for playing a variety of URLs, including YouTube.
...
* [lightGallery](https://github.com/sachinchoolur/lightGallery) ⭐ 7,055 | 🐛 65 | 🌐 TypeScript | 📅 2026-09-23 - [demo](https://www.lightgalleryjs.com/) - [docs](https://www.lightgalleryjs.com/docs/react/) - Full-featured lightbox gallery component.
...
* [Lucide](https://github.com/lucide-icons/lucide) ⭐ 24,719 | 🐛 460 | 🌐 TypeScript | 📅 2026-09-25 - Beautiful & consistent icon toolkit made by the community. Open-source project and a fork of Feather Icons.
...
* [react-markdown](https://github.com/rexxars/react-markdown) ⭐ 15,892 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-24 - Render Markdown as React components.

### Canvas

*Sketch input using Canvas or SVG*

* [react-konva](https://github.com/konvajs/react-konva) ⭐ 6,422 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-15 - React Konva is a JavaScript library for drawing complex canvas graphics with bindings to the Konva Framework.
...
* [puck](https://github.com/measuredco/puck) ⭐ 13,365 | 🐛 198 | 🌐 TypeScript | 📅 2026-09-25 - [demo](https://puck-editor-demo.vercel.app/edit) - The self-hosted visual editor for React
...
* [react-joyride](https://github.com/gilbarbara/react-joyride) ⭐ 7,869 | 🐛 5 | 🌐 TypeScript | 📅 2026-07-09 - Create walkthroughs and guided tours for your ReactJS apps. Now with standalone tooltips!.
...
* [schedule-x](https://github.com/schedule-x/schedule-x) ⭐ 2,585 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-25 - Material design event calendar and date picker components. Demo site: <https://schedule-x.dev/>
...
* [react-awesome-stars-rating](https://github.com/fedoryakubovich/react-awesome-stars-rating) ⭐ 40 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-25 - [demo](https://react-awesome-stars-rating.herokuapp.com/) - The star rating component with accessibility.
...
* [react-draggable](https://github.com/mzabriskie/react-draggable) ⭐ 9,286 | 🐛 208 | 🌐 JavaScript | 📅 2026-09-16 - React draggable component.
...
* [tiptap](https://github.com/ueberdosis/tiptap) ⭐ 38,525 | 🐛 826 | 🌐 TypeScript | 📅 2026-09-25 - [demo](https://tiptap.dev/) - [docs](https://tiptap.dev/introduction) - The headless editor framework for web artisans.
...
* [react-grid-layout](https://github.com/STRML/react-grid-layout) ⭐ 22,437 | 🐛 61 | 🌐 TypeScript | 📅 2026-09-16 - A draggable and resizable grid layout with responsive breakpoints, for React.
...
* [framer-motion](https://github.com/framer/motion) ⭐ 33,725 | 🐛 114 | 🌐 TypeScript | 📅 2026-09-25 - An animation and gesture library.
* [react-spring](https://github.com/react-spring/react-spring) ⭐ 29,161 | 🐛 70 | 🌐 TypeScript | 📅 2026-09-25 - A spring physics based animation library.
...
* [shadcn/ui](https://github.com/shadcn-ui/ui) ⭐ 124,583 | 🐛 1,839 | 🌐 TypeScript | 📅 2026-09-24 - [demo](https://ui.shadcn.com/examples/mail) - [docs](https://ui.shadcn.com/docs) - Beautifully designed components that you can copy and paste into your apps.
* [ant-design](https://github.com/ant-design/ant-design) ⭐ 99,615 | 🐛 1,076 | 🌐 TypeScript | 📅 2026-09-25 - [demo/docs](https://ant.design/docs/react/introduce) - A UI Design Language from China. Individual [components](http://react-component.github.io/) available.
...
* [Mantine](https://github.com/mantinedev/mantine) ⭐ 31,770 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-23 - [demo/docs](https://mantine.dev/) - A fully featured library with 100+ hooks and components with native dark theme support
...
* [fluentui](https://github.com/microsoft/fluentui) ⭐ 20,294 | 🐛 808 | 🌐 TypeScript | 📅 2026-09-25 - UX frameworks for creating beautiful, cross-platform apps that share code, design, and interaction behavior.
...
* [semi-design](https://github.com/DouyinFE/semi-design) ⭐ 10,386 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-17 - [demo/docs](https://semi.design/) - A modern, comprehensive, flexible design system.
* [carbon](https://github.com/carbon-design-system/carbon) ⭐ 9,491 | 🐛 1,075 | 🌐 JavaScript | 📅 2026-09-25 - [demo/docs](https://www.carbondesignsystem.com/) - A design system built by IBM.
* [reakit](https://github.com/ariakit/ariakit) ⭐ 8,625 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-25 - [demo/docs](https://reakit.io/docs/button/) Toolkit for building accessible rich web apps
* [grommet](https://github.com/grommet/grommet) ⭐ 8,347 | 🐛 492 | 🌐 JavaScript | 📅 2026-09-25 - The most advanced UX framework for enterprise applications.
* [primereact](https://github.com/primefaces/primereact) ⭐ 8,312 | 🐛 324 | 🌐 CSS | 📅 2026-09-24 - A complete UI Framework with 50+ components featuring material, bootstrap and custom themes.
...
* [kokonut-ui](https://github.com/kokonut-labs/kokonutui) ⭐ 2,119 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-20 - Free Modern and Customizable UI components.
* [untitled-ui-react](https://github.com/untitleduico/react) ⭐ 1,942 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-22 - [demo](https://www.untitledui.com/react/) - Beautifully crafted collection of components built with React Aria and Tailwind CSS.
...
* 🚀 [Material UI](https://github.com/mui/material-ui) ⭐ 99,096 | 🐛 1,450 | 🌐 JavaScript | 📅 2026-09-25 - Full suite of components. Build your own design system, or start with Material Design.
...
* [refine](https://github.com/pankod/refine) ⭐ 35,730 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-10 - [demo](https://example.refine.dev) - [docs](https://refine.dev/docs) - Build data-intensive applications in no time. It ships with Ant Design System, an enterprise-level UI toolkit.
* [react-admin](https://github.com/marmelab/react-admin) ⭐ 26,943 | 🐛 64 | 🌐 TypeScript | 📅 2026-09-25 - Build admin user experiences on top of REST and GraphQL services.
* [blueprint](https://github.com/palantir/blueprint) ⭐ 22,097 | 🐛 956 | 🌐 TypeScript | 📅 2026-09-24 - [demo](https://blueprintjs.com/) - [docs](https://blueprintjs.com/docs/) - UI toolkit for building complex, data-dense web interfaces for desktop (not mobile) applications.
* [rsuite](https://github.com/rsuite/rsuite) ⭐ 8,695 | 🐛 321 | 🌐 TypeScript | 📅 2026-08-21 - [demo/docs](https://rsuitejs.com/) - Suite of components for "enterprise system products".
...
* [zustand](https://zustand.surge.sh/) - [docs](https://github.com/pmndrs/zustand) ⭐ 58,747 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-22 - A fast bearbones state-management solution using simplified flux principles and boilerplate-free hook api.
* [react-redux](https://github.com/reactjs/react-redux) ⭐ 23,426 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-24 - Official React bindings for Redux.
* [RxDB](https://rxdb.info/) - [demo](https://github.com/pubkey/rxdb/tree/master/examples/react) ⭐ 23,390 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-25 - [docs](https://rxdb.info/quickstart.html) A fast, local first, reactive Database for JavaScript Applications
...
* [react-hook-form](https://github.com/react-hook-form/react-hook-form) ⭐ 44,865 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-24 - React hooks for form validation without the hassle.
...
* [react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) ⭐ 15,906 | 🐛 114 | 🌐 TypeScript | 📅 2026-09-25 - A React component for building Web forms from JSONSchema.
...
* [surveyjs](https://github.com/surveyjs/survey-library) ⭐ 4,879 | 🐛 477 | 🌐 TypeScript | 📅 2026-09-25 - The advanced Survey and Form library
...
* [react-router](https://github.com/reactjs/react-router) ⭐ 56,586 | 🐛 194 | 🌐 TypeScript | 📅 2026-09-25 - A complete routing library for React.
* [tanstack-router](https://github.com/TanStack/router) ⭐ 15,130 | 🐛 663 | 🌐 TypeScript | 📅 2026-09-25 - Type-safe router with built-in caching & URL state management
...
* [query](https://github.com/TanStack/query) ⭐ 50,358 | 🐛 172 | 🌐 TypeScript | 📅 2026-09-25 - [docs](https://tanstack.com/query/v4) Powerful asynchronous state management, server-state utilities and data fetching for TS/JS, React, Solid, Svelte and Vue.
* [apollo-client](https://github.com/apollostack/apollo-client) ⭐ 19,804 | 🐛 411 | 🌐 TypeScript | 📅 2026-09-25 - A simple caching client for any GraphQL server and UI framework.
* [react-relay](https://github.com/facebook/relay) ⭐ 18,965 | 🐛 864 | 🌐 Rust | 📅 2026-09-25 - Relay is a JavaScript framework for building data-driven React applications.

### CSS / Style

* [styled-components](https://github.com/styled-components/styled-components) ⭐ 41,101 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-24 - Visual primitives for the component age.
...
* [rockpack](https://github.com/AlexSergey/rockpack) ⭐ 1,113 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-25 - Simple solution for creating React application with SSR, bundling, linting, testing within 5 minutes.
* [extensive-react-boilerplate](https://github.com/brocoders/extensive-react-boilerplate) ⭐ 512 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-25 - Boilerplate with Next.js, Auth (Sign in, Sign up, Reset password, Confirm email, Refresh Token), Material UI, React Hook Form, I18N, File uploads (support local and Amazon S3 drivers), Tests, CI.
...
* [qrcode.react](https://github.com/zpao/qrcode.react) ⭐ 4,286 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-25 - A \<QRCode/> component for use with React.
...
* [react-intl](https://github.com/yahoo/react-intl) ⭐ 14,744 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-25 - Internationalize React apps.
...
* [js-lingui](https://github.com/lingui/js-lingui) ⭐ 5,896 | 🐛 64 | 🌐 TypeScript | 📅 2026-09-25 - [docs](https://lingui.js.org) – A readable, automated, and optimized (5 kb) internationalization for JavaScript.
...
* [react-on-rails](https://github.com/shakacode/react_on_rails) ⭐ 5,190 | 🐛 114 | 🌐 Ruby | 📅 2026-09-25 - Integration of React + Webpack + Rails to build Universal (Isomorphic) Apps.
...
* [inferno](https://github.com/trueadm/inferno) ⭐ 16,457 | 🐛 40 | 🌐 JavaScript | 📅 2026-09-25 - An extremely fast, React-like JavaScript library for building modern user interfaces.
...
* [playwright](https://github.com/microsoft/playwright) ⭐ 96,673 | 🐛 177 | 🌐 TypeScript | 📅 2026-09-25 enables reliable end-to-end testing for modern web apps.
* [jest-cli](https://github.com/facebook/jest) ⭐ 45,465 | 🐛 211 | 🌐 TypeScript | 📅 2026-09-24 - Painless JavaScript Testing.
...
* [redux-devtools](https://github.com/gaearon/redux-devtools) ⭐ 14,368 | 🐛 142 | 🌐 TypeScript | 📅 2026-09-25 - DevTools for Redux with hot reloading, action replay, and customizable UI.
...
* [iron-session](https://github.com/vvo/iron-session) ⭐ 4,144 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-23 - Secure, stateless, and cookie-based session library.
...
* [gatsby](https://github.com/gatsbyjs/gatsby) ⭐ 55,944 | 🐛 450 | 🌐 JavaScript | 📅 2026-09-25 - Transform plain text into dynamic blogs and websites using React.js.
