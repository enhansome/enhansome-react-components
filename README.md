...
Please review our [contributing guidelines](https://github.com/brillout/awesome-react-components/blob/master/CONTRIBUTING.md) ⭐ 48,333 | 🐛 88 | 📅 2026-01-26. We keep this list fresh by **requiring all PRs to remove one or more non-awesome entries from this list**. Please ONLY PR a new resource if you are ALSO removing one.
...
* [Handsontable](https://github.com/handsontable/handsontable) ⭐ 22,037 | 🐛 29 | 🌐 JavaScript | 📅 2026-09-04 - [demo](https://handsontable.com/demo) - [docs](https://handsontable.com/docs/react-data-grid/) - Data Grid with spreadsheet-like UI supporting React, Angular, TypeScript and JavaScript.
* [AG Grid](https://github.com/ag-grid/ag-grid) ⭐ 15,583 | 🐛 128 | 🌐 TypeScript | 📅 2026-09-04 - Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components.
* [react-data-grid](https://github.com/adazzle/react-data-grid) ⭐ 7,676 | 🐛 74 | 🌐 TypeScript | 📅 2026-09-04 - Excel-like grid.
* [MUI X Data grid](https://github.com/mui/mui-x) ⭐ 5,841 | 🐛 1,438 | 🌐 TypeScript | 📅 2026-09-04 - [demo/docs](https://mui.com/x/react-data-grid/) - Fast and customizable data grid with advanced features for power users and complex use cases.
...
* [revo-grid](https://github.com/revolist/revogrid) ⭐ 3,440 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-04 - [demo/docs](https://revolist.github.io/revogrid/) - Powerfull Data Grid for React / AngularJS / Vue / Web Components with advanced customization.
...
* [TanStack Table](https://github.com/tannerlinsley/react-table) ⭐ 28,407 | 🐛 62 | 🌐 TypeScript | 📅 2026-08-31 - [demo](https://tanstack.com/table/v8/docs/examples/react/basic) - Headless UI for building powerful tables & datagrids
...
* [Material-React-Table](https://github.com/KevinVandy/material-react-table) ⭐ 1,801 | 🐛 172 | 🌐 TypeScript | 📅 2026-06-05 - A fully featured Material UI V5 implementation of TanStack React Table V8, written from the ground up in TypeScript
...
* [react-window](https://github.com/bvaughn/react-window) ⭐ 17,207 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-20 - [demo](https://react-window.now.sh/) - React components for efficiently rendering large lists and tabular data
...
* [virtua](https://github.com/inokawa/virtua) ⭐ 3,734 | 🐛 61 | 🌐 TypeScript | 📅 2026-09-04 - [demo](https://inokawa.github.io/virtua/) - A zero-config, fast and small (\~3kB) virtual list component for React, Vue and Solid.
...
* [react-tabs](https://github.com/reactjs/react-tabs) ⭐ 3,148 | 🐛 58 | 🌐 JavaScript | 📅 2026-09-03 - React tabs component.
...
* [procaptcha](https://github.com/prosopo/captcha) ⭐ 298 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-04 - [demo](https://prosopo.io/) - [docs](https://docs.prosopo.io/) - Privacy focused free CAPTCHA
...
* [recharts](https://github.com/recharts/recharts) ⭐ 27,540 | 🐛 440 | 🌐 TypeScript | 📅 2026-09-04 - Redefined chart library built with React and D3.
...
* [lightGallery](https://github.com/sachinchoolur/lightGallery) ⭐ 7,054 | 🐛 65 | 🌐 TypeScript | 📅 2026-09-03 - [demo](https://www.lightgalleryjs.com/) - [docs](https://www.lightgalleryjs.com/docs/react/) - Full-featured lightbox gallery component.
...
* [Lucide](https://github.com/lucide-icons/lucide) ⭐ 24,357 | 🐛 497 | 🌐 TypeScript | 📅 2026-09-04 - Beautiful & consistent icon toolkit made by the community. Open-source project and a fork of Feather Icons.
* [react-icons](https://github.com/gorangajic/react-icons) ⭐ 12,646 | 🐛 239 | 🌐 TypeScript | 📅 2026-08-12 - Svg react icons of popular icon packs using ES6 imports.
...
* [puck](https://github.com/measuredco/puck) ⭐ 13,262 | 🐛 193 | 🌐 TypeScript | 📅 2026-09-04 - [demo](https://puck-editor-demo.vercel.app/edit) - The self-hosted visual editor for React
* [react-pdf](https://github.com/wojtekmaj/react-pdf) ⭐ 11,163 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-04 - Display PDFs in your React app as easily as if they were images.
* [react-joyride](https://github.com/gilbarbara/react-joyride) ⭐ 7,852 | 🐛 5 | 🌐 TypeScript | 📅 2026-07-09 - Create walkthroughs and guided tours for your ReactJS apps. Now with standalone tooltips!.
...
* [schedule-x](https://github.com/schedule-x/schedule-x) ⭐ 2,553 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-04 - Material design event calendar and date picker components. Demo site: <https://schedule-x.dev/>
...
* [react-select](https://github.com/JedWatson/react-select) ⭐ 28,029 | 🐛 489 | 🌐 TypeScript | 📅 2026-07-16 - A Select control built with and for React JS.
...
* [react-dropzone](https://github.com/okonet/react-dropzone) ⭐ 11,016 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-30 - Simple HTML5 drag-drop zone with React.js.
...
* [tiptap](https://github.com/ueberdosis/tiptap) ⭐ 38,273 | 🐛 827 | 🌐 TypeScript | 📅 2026-09-04 - [demo](https://tiptap.dev/) - [docs](https://tiptap.dev/introduction) - The headless editor framework for web artisans.
...
* [framer-motion](https://github.com/framer/motion) ⭐ 33,483 | 🐛 108 | 🌐 TypeScript | 📅 2026-09-02 - An animation and gesture library.
...
* [react-tsparticles](https://github.com/matteobruni/tsparticles/blob/master/components/react/README.md) ⭐ 8,976 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-02 - A lightweight component to easily create interactive particles animations
...
* [shadcn/ui](https://github.com/shadcn-ui/ui) ⭐ 123,019 | 🐛 2,083 | 🌐 TypeScript | 📅 2026-09-04 - [demo](https://ui.shadcn.com/examples/mail) - [docs](https://ui.shadcn.com/docs) - Beautifully designed components that you can copy and paste into your apps.
* [ant-design](https://github.com/ant-design/ant-design) ⭐ 99,387 | 🐛 1,101 | 🌐 TypeScript | 📅 2026-09-04 - [demo/docs](https://ant.design/docs/react/introduce) - A UI Design Language from China. Individual [components](http://react-component.github.io/) available.
* [chakra-ui](https://github.com/chakra-ui/chakra-ui) ⭐ 40,621 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-04 - [demo/docs](https://chakra-ui.com) - Simple, Modular & Accessible UI Components for your React Applications.
* [Mantine](https://github.com/mantinedev/mantine) ⭐ 31,665 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-01 - [demo/docs](https://mantine.dev/) - A fully featured library with 100+ hooks and components with native dark theme support
* [react-bootstrap](https://github.com/react-bootstrap/react-bootstrap) ⭐ 22,603 | 🐛 237 | 🌐 TypeScript | 📅 2026-09-04 - Bootstrap components built with React.
* [fluentui](https://github.com/microsoft/fluentui) ⭐ 20,247 | 🐛 790 | 🌐 TypeScript | 📅 2026-09-03 - UX frameworks for creating beautiful, cross-platform apps that share code, design, and interaction behavior.
...
* [semi-design](https://github.com/DouyinFE/semi-design) ⭐ 10,347 | 🐛 36 | 🌐 TypeScript | 📅 2026-09-01 - [demo/docs](https://semi.design/) - A modern, comprehensive, flexible design system.
* [carbon](https://github.com/carbon-design-system/carbon) ⭐ 9,426 | 🐛 1,027 | 🌐 JavaScript | 📅 2026-09-04 - [demo/docs](https://www.carbondesignsystem.com/) - A design system built by IBM.
* [reakit](https://github.com/ariakit/ariakit) ⭐ 8,609 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-04 - [demo/docs](https://reakit.io/docs/button/) Toolkit for building accessible rich web apps
* [grommet](https://github.com/grommet/grommet) ⭐ 8,352 | 🐛 478 | 🌐 JavaScript | 📅 2026-09-04 - The most advanced UX framework for enterprise applications.
...
* [untitled-ui-react](https://github.com/untitleduico/react) ⭐ 1,899 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-02 - [demo](https://www.untitledui.com/react/) - Beautifully crafted collection of components built with React Aria and Tailwind CSS.
...
* 🚀 [Material UI](https://github.com/mui/material-ui) ⭐ 99,010 | 🐛 1,473 | 🌐 JavaScript | 📅 2026-09-04 - Full suite of components. Build your own design system, or start with Material Design.
...
* [antd-mobile](https://github.com/ant-design/ant-design-mobile) ⭐ 12,043 | 🐛 224 | 🌐 TypeScript | 📅 2026-08-05 - Configurable Mobile UI from China.
...
* [refine](https://github.com/pankod/refine) ⭐ 35,631 | 🐛 44 | 🌐 TypeScript | 📅 2026-06-05 - [demo](https://example.refine.dev) - [docs](https://refine.dev/docs) - Build data-intensive applications in no time. It ships with Ant Design System, an enterprise-level UI toolkit.
* [react-admin](https://github.com/marmelab/react-admin) ⭐ 26,921 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-04 - Build admin user experiences on top of REST and GraphQL services.
* [blueprint](https://github.com/palantir/blueprint) ⭐ 22,031 | 🐛 941 | 🌐 TypeScript | 📅 2026-09-02 - [demo](https://blueprintjs.com/) - [docs](https://blueprintjs.com/docs/) - UI toolkit for building complex, data-dense web interfaces for desktop (not mobile) applications.
...
* [zustand](https://zustand.surge.sh/) - [docs](https://github.com/pmndrs/zustand) ⭐ 58,645 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-31 - A fast bearbones state-management solution using simplified flux principles and boilerplate-free hook api.
* [react-redux](https://github.com/reactjs/react-redux) ⭐ 23,443 | 🐛 58 | 🌐 TypeScript | 📅 2026-09-03 - Official React bindings for Redux.
* [RxDB](https://rxdb.info/) - [demo](https://github.com/pubkey/rxdb/tree/master/examples/react) ⭐ 23,374 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-04 - [docs](https://rxdb.info/quickstart.html) A fast, local first, reactive Database for JavaScript Applications
* [reselect](https://github.com/reactjs/reselect) ⭐ 19,017 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-02 - Selector library for Redux.
* [effector-react](https://github.com/effector/effector) ⭐ 4,850 | 🐛 159 | 🌐 TypeScript | 📅 2026-09-01 - React bindings for effector, an effective multi-store state manager.
...
* [react-hook-form](https://github.com/react-hook-form/react-hook-form) ⭐ 44,849 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-04 - React hooks for form validation without the hassle.
...
* [react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) ⭐ 15,888 | 🐛 145 | 🌐 TypeScript | 📅 2026-09-03 - A React component for building Web forms from JSONSchema.
...
* [surveyjs](https://github.com/surveyjs/survey-library) ⭐ 4,865 | 🐛 484 | 🌐 TypeScript | 📅 2026-09-04 - The advanced Survey and Form library
...
* [tanstack-router](https://github.com/TanStack/router) ⭐ 15,039 | 🐛 613 | 🌐 TypeScript | 📅 2026-09-04 - Type-safe router with built-in caching & URL state management
* [wouter](https://github.com/molefrog/wouter) ⭐ 7,875 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-21 - A minimalist-friendly \~1.3KB routing library. Nothing else but hooks.
...
* [query](https://github.com/TanStack/query) ⭐ 50,266 | 🐛 156 | 🌐 TypeScript | 📅 2026-09-04 - [docs](https://tanstack.com/query/v4) Powerful asynchronous state management, server-state utilities and data fetching for TS/JS, React, Solid, Svelte and Vue.
* [apollo-client](https://github.com/apollostack/apollo-client) ⭐ 19,813 | 🐛 403 | 🌐 TypeScript | 📅 2026-09-03 - A simple caching client for any GraphQL server and UI framework.
...
* [styled-components](https://github.com/styled-components/styled-components) ⭐ 41,124 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-28 - Visual primitives for the component age.
...
* [react-call](https://github.com/desko27/react-call) ⭐ 1,368 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-01 - Call your React components.
...
* [react-intl](https://github.com/yahoo/react-intl) ⭐ 14,747 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-04 - Internationalize React apps.
...
* [js-lingui](https://github.com/lingui/js-lingui) ⭐ 5,870 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-04 - [docs](https://lingui.js.org) – A readable, automated, and optimized (5 kb) internationalization for JavaScript.
...
* [@tolgee/react](https://github.com/tolgee/tolgee-js/tree/main/packages/react) ⭐ 260 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-04 - [docs](https://tolgee.io/docs/web/using_with_react/installation) – Web-based localization tool enabling users to translate directly in the React app they develop
...
* [react-on-rails](https://github.com/shakacode/react_on_rails) ⭐ 5,191 | 🐛 109 | 🌐 Ruby | 📅 2026-09-04 - Integration of React + Webpack + Rails to build Universal (Isomorphic) Apps.
...
* [react-virtualized](https://github.com/bvaughn/react-virtualized) ⭐ 27,079 | 🐛 0 | 🌐 JavaScript | 📅 2025-01-20 - React components for efficiently rendering large lists and tabular data.
...
* [playwright](https://github.com/microsoft/playwright) ⭐ 95,635 | 🐛 183 | 🌐 TypeScript | 📅 2026-09-04 enables reliable end-to-end testing for modern web apps.
* [jest-cli](https://github.com/facebook/jest) ⭐ 45,472 | 🐛 189 | 🌐 TypeScript | 📅 2026-09-03 - Painless JavaScript Testing.
...
* [redux-devtools](https://github.com/gaearon/redux-devtools) ⭐ 14,367 | 🐛 230 | 🌐 TypeScript | 📅 2026-09-04 - DevTools for Redux with hot reloading, action replay, and customizable UI.
...
* [gatsby](https://github.com/gatsbyjs/gatsby) ⭐ 55,938 | 🐛 442 | 🌐 JavaScript | 📅 2026-09-04 - Transform plain text into dynamic blogs and websites using React.js.
